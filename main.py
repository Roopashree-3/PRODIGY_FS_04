...
def main(page: ft.Page):
    ...
    def btn_signup(e):
        page.route = "/signup"  # Ensure we change the route to /signup
        page.update()  # Update the page after changing the route
        print("Navigating to sign-up form...")  # Debugging statement to ensure function is called
    ...
    def route_change(route):
        if page.route == "/":
            ...
            page.add(
                ft.Row(
                    [principal_content, signin_UI.build()],
                    alignment=ft.MainAxisAlignment.CENTER,
                )
            )
        ...
        if page.route == "/signup":
            ...
            page.add(
                ft.Row(
                    [principal_content, signup_UI.build()],  # Use .build() to ensure it renders correctly
                    alignment=ft.MainAxisAlignment.CENTER,
                )
            )
